                                ...
                                <thead>
                                    ...
                                    <?php 
                                        ...
                                        while($hasil=mysqli_fetch_array($data)){
                                            ...
                                            color: white;
                                            padding: 5px;
                                            border-radius: 3px;' href='../../proyek1/Edit_data/edit_bayi.php?edit=".$hasil['nama']."'>Edit</a>
                                        ...
                                        mysqli_free_result($data); // Jangan lupa untuk membebaskan hasil query setelah selesai menggunakan
