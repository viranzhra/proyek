                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                                <?php 
                                    ...
                                    function konfirmasiHapus(nama) {
                                        var result = confirm("Apakah Anda yakin ingin menghapus data " + nama + "?");
                                        if (result) {
                            ...
                            <?php if (isset($berhasil)) {
                               echo "<span id='alertSpan' style='margin-left: 500px;
                               position: absolute;
                               top: 10px;
                               color: white;
                               background: #a1caa1;
                               padding: 3px;
                               border-radius: 3px;'>$berhasil</span>";
                                echo "<script>
                                        setTimeout(function() {
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-responsive" id="dataTable" style="width: 1450px;" cellspacing="0">    
                                <thead>
                                        <tr>
                                    ...
                                    while($hasil=mysqli_fetch_array($data)){
                                        ...
                                        echo "<td><a style='background-color: #58d258;
                                                                                color: white;
                                                                                padding: 5px;
                                                                                border-radius: 3px;' href='../../proyek1/Edit_data/edit_hamil.php?edit=".$hasil['nama']."'>Edit</a>
